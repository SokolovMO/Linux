...
* важное замечание - при установке ubuntu вам будет предложено установить проприетарные драйверы, не выбираем этот путь, а выбираем путь бойца и ставим все из консольки. также желательно произвести установку без подключения к сети, а после установки сделать команду `sudo apt update && sudo apt upgrade`
